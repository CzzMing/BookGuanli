...
import com.buba.filter.URLPathMatchingFilter;
import com.buba.realm.WJRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/user/authentication", "authc"); // 防鸡贼登录
        filterChainDefinitionMap.put("/user/menu", "authc");
        filterChainDefinitionMap.put("/user/admin/**", "authc");

        filterChainDefinitionMap.put("/user/admin/**", "url");  // 自定义过滤器设置 3，设置过滤路径
